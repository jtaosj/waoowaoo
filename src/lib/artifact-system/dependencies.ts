...
const invalidationMap: Record<ArtifactType, ArtifactType[]> = {
  ...
  [ARTIFACT_TYPES.VOICE_LINES]: [],
  [ARTIFACT_TYPES.PANEL_PROMPT]: [ARTIFACT_TYPES.PANEL_IMAGE, ARTIFACT_TYPES.PANEL_VIDEO, ARTIFACT_TYPES.FINAL_VIDEO],
  [ARTIFACT_TYPES.PANEL_IMAGE]: [ARTIFACT_TYPES.PANEL_VIDEO, ARTIFACT_TYPES.FINAL_VIDEO],
  [ARTIFACT_TYPES.PANEL_VIDEO]: [ARTIFACT_TYPES.FINAL_VIDEO],
  [ARTIFACT_TYPES.FINAL_VIDEO]: [],
}
